package com.penod.mylibrary.player;
...
public class JZMediaManager implements TextureView.SurfaceTextureListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    private static com.penod.mylibrary.player.JZMediaManager JZMediaManager;
    ...
    public static com.penod.mylibrary.player.JZMediaManager instance() {
            ...
            switch (msg.what) {
                case HANDLER_PREPARE:
                    try {
                        ...
                        mediaPlayer.setOnPreparedListener(com.penod.mylibrary.player.JZMediaManager.this);
                        mediaPlayer.setOnCompletionListener(com.penod.mylibrary.player.JZMediaManager.this);
                        mediaPlayer.setOnBufferingUpdateListener(com.penod.mylibrary.player.JZMediaManager.this);
                        mediaPlayer.setScreenOnWhilePlaying(true);
                        mediaPlayer.setOnSeekCompleteListener(com.penod.mylibrary.player.JZMediaManager.this);
                        mediaPlayer.setOnErrorListener(com.penod.mylibrary.player.JZMediaManager.this);
                        mediaPlayer.setOnInfoListener(com.penod.mylibrary.player.JZMediaManager.this);
                        mediaPlayer.setOnVideoSizeChangedListener(com.penod.mylibrary.player.JZMediaManager.this);
